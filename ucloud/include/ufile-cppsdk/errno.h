...
#define UFILE_ERROR_DESC(retcode) ucloud::cppsdk::error::UFileError::Instance().ErrorDesc(retcode)
...
#define UFILE_LAST_RETCODE() ucloud::cppsdk::error::UFileError::Instance().LastRetcode()

#define UFILE_LAST_ERRMSG() ucloud::cppsdk::error::UFileError::Instance().LastErrmsg()
