...
inline int JsonGetString(const json_object *root, const std::string &key, std::string &value) {
    if (!root) return -1;
...
inline int JsonGetInt64(const json_object *root, const std::string &key, int64_t &value) {
...
inline int JsonGetSizet(const json_object *root, const std::string &key, size_t &value) {
...
inline int JsonGetString(const std::string &data, const std::string &key, std::string &value) {
...
inline int JsonGetInt64(const std::string &data, const std::string &key, int64_t &value) {
...
inline int JsonGetSizet(const std::string &data, const std::string &key, size_t &value) {
